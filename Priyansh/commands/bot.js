...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "inbox") || (event.body.toLowerCase() == "ib")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "admin")) {
     return api.sendMessage("𒁍 ⃝𝐎𝐖𝐍𝐄𝐑 ⸙𓆩𝐇𝐀𝐍𝐙𝐔𓆪 𓆣 »❯🥀🖤", threadID);
   };
...
if ((event.body.toLowerCase() == "😀") || (event.body.toLowerCase() == "😀😀")) {
   ...
   if ((event.body.toLowerCase() == "hanzala") || (event.body.toLowerCase() == "boss ko bala bhula oye😎😎🙄")) {
     return api.sendMessage("Awww Meko V LoooNa Aa RaHa 🥹🥺", threadID);
   };

   if ((event.body.toLowerCase() == "hanzu") || (event.body.toLowerCase() == "Boss busy Hai mujh se bat karo 🙄🙄")) {
